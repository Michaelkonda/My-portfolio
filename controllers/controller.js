...
router.post('/contact/send', function(req, res, next) {
    var transporter = nodemailer.createTransport({
        ...
        service: 'Gmail',
        auth: {
            user: 'sendmailtome228@gmail.com@gmail.com',
            pass: 'sendmail228'
        }
    });
    ...
    var mailOptions = {
        ...
        from: 'Website User <sendmailtome228@gmail.com@gmail.com>',
        to: 'michaelkonda11@gmail.com',
        subject: 'Website Submission from michaelkonda.com',
